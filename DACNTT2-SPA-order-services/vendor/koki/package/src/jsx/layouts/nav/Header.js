               ...
               <div className="collapse navbar-collapse justify-content-between">
                  ...
                  <ul className="navbar-nav header-right">
                     ...
                     <li className="nav-item dropdown notification_dropdown">
                        ...
                        <div
                           className={`dropdown-menu dropdown-menu-right ${toggle === "activity" ? "show" : ""
                              }`}
                        >
                           <PerfectScrollbar
                              id="DZ_W_Notification1"
                              className={` widget-media dz-scroll p-3 height380 ${toggle === "activity"
                                 ? "ps ps--active-y"
                                 : ""
                                 }`}
                           >
                     ...
                     <li className="nav-item dropdown notification_dropdown">
                        ...
                        <div
                           className={`dropdown-menu dropdown-menu-right p-3 ${toggle === "notification" ? "show" : ""
                              }`}
                        >
                           <PerfectScrollbar
                              id="DZ_W_Gifts"
                              className={` widget-timeline dz-scroll style-1 ${toggle === "notification"
                                 ? "ps ps--active-y"
                                 : ""
                                 }`}
                           >
